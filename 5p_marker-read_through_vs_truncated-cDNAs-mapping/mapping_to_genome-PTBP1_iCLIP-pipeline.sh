...
# map to hg19
bowtie2-align -x ~/bowtie-indexes/hg19/hg19 -f ${path}${data}-trimmed-readThrough.fa -S ${path}${data}-trimmed-readThrough.sam
bowtie2-align -x ~/bowtie-indexes/hg19/hg19 -f ${path}${data}-trimmed-truncated.fa -S ${path}${data}-trimmed-truncated.sam
